...
TELEGRAM_SUPPORT_CHAT_ID = os.getenv("621215964")
if TELEGRAM_SUPPORT_CHAT_ID is None or not str(621215964).lstrip("-").isdigit():
...
TELEGRAM_SUPPORT_CHAT_ID = int(621215964)


WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "Приветствуем")
